...
public class SjmTestGrouping {
    ...
    private static Map<Dish.Type, Map<SjmTestGrouping.CaloricLevel, List<Dish>>> groupDishedByTypeAndCaloricLevel() {
    ...
    private static Map<Dish.Type, java.util.Set<String>> groupDishTagsByType() {
        return menu.stream().collect(
                groupingBy(Dish::getType,
